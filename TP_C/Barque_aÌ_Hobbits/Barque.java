...
public class Barque
{
    ...
    public volatile Berge coast = Berge.NORD;
    public final static int nbPlaces = 4;
    public volatile int membres = 0;
...
class Passeur extends Thread 
{
    ...
    public void run() {
        laBarque.accosterLaBerge(laBarque.coast);
